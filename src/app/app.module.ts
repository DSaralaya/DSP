...
@NgModule({
	declarations: [ AppComponent, GetStartedComponent, ConfirmationComponent, ProgressComponent, DynamicComponent, SessionExpireComponent, HeaderComponent, FooterComponent, PageHeaderComponent ],
