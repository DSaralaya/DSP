...
export const Configmod= FormlyModule.forRoot({ 
    ...
    { name: 'Currency', component: currencyService,wrappers: ['fieldset', 'label'] },
    { name: 'masking', component: maskService,wrappers: ['fieldset', 'label'] },
    { name: 'dob', extends: 'masking',
        defaultOptions:{
            validators: {
                invalidDate: (control: FormControl, field: any) => ValidationService.validDateValidator(control,field),
                minorAge: (control: FormControl, field: any) =>ValidationService.minorAgeValidation(control,field),
                futuredate:(control: FormControl, field: any) =>ValidationService.fututeDateValidation(control)
            }
